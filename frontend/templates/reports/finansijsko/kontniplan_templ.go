...
// KontniPlanStampa renders a printable Kontni plan report.
func KontniPlanStampa(repParams domain.ReportParameters, tbl domain.TableData, translator *i18n.Service) templ.Component {
